...
SECRET_KEY = 'django-insecure-szsffq)un#)f!*3+yx&+r1kb7i&to$ba+^^g1sbwd9bd*!$fnh'
...
SIMPLE_JWT = {
    ...
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=60),  # now 1 hour

    # Refresh token lifetime (default is 1 day)
    'REFRESH_TOKEN_LIFETIME': timedelta(days=7),  # now 7 days
